    ...
    return(
        <div>
            <div className={`${(theme) && 'dark'} flex-column items-center justify-start p-10 top-0 z-50 border-t-8 border-t-black bg-darkgray text-4xl text-white dark:border-t-white md:hidden`}>
                <Link to='https://www.linkedin.com/in/rsariego/' target='_blank'><i className="fa-brands fa-linkedin text-yellow"></i></Link>

                <Link to='https://github.com/nopicklesplease' target='_blank'><i className="fa-brands fa-github  ml-4 text-yellow"></i></Link>
                ...
                <div className='pt-3 font-roboto font-light text-sm tracking-widest flex-column'>
                    ...
                    <p className='flex justify-end pt-6'><i className="fa-regular fa-copyright mr-2"></i> 2023</p>
                </div>
            </div>
