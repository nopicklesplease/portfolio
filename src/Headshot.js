...
const Headshot = () => {
    return(
            <div className='text-white text-5xl'>
                ...
                <Link tabindex='-1' to='https://www.linkedin.com/in/rsariego/' title='LinkedIn Profile' target='_blank'>
                    <i className="fa-brands fa-linkedin mt-4 hover:text-black dark:hover:text-yellow"></i>
                </Link>
                <Link tabindex='-1' to='https://github.com/nopicklesplease' title='Github Profile' target='_blank'>
